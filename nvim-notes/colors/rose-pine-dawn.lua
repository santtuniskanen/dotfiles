...
hl("CursorLineNr", { fg = colors.iris, bold = true })
...
hl("ModeMsg", { fg = colors.foam, bold = true })
...
hl("TabLineSel", { fg = colors.iris, bg = colors.base, bold = true })
hl("Title", { fg = colors.iris, bold = true })
